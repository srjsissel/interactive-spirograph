...
import {ExampleCurveModel2} from "./ExampleCurveModel2";

export class ExampleCurveView2 extends ANodeView2D{
    stroke!:ALineGraphic;
    strokeVerts!:VertexArray2D;
    controlShape!:ALineGraphic;
    handles:Handle2DGraphic[]=[];
    nSamplesPerSegment:number=25;
    get model():ExampleCurveModel2{
        return this._model as ExampleCurveModel2;
    }
    ...
    getCurveVertices(){
        ...
        let viewVerts = this.model.verts.clone();
        viewVerts.initColorAttribute();
        viewVerts.FillColor(Color.FromString("#0033aa"))
        return viewVerts;
    }
